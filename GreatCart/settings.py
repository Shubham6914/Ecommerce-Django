...
SECRET_KEY = 'django-insecure-!o2q5_+jac6p#n7q-zg7j-!@++1%n%r6941g)g55t-o7cf5%oh'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'category.context_processors.menu_links',#now we can use this dynamically in any template
